...
cdef extern from "TACSSimpPlaneStressConstitutive.h":
    cdef cppclass TACSSimpPlaneStressConstitutive(TACSPlaneStressConstitutive):
        TACSSimpPlaneStressConstitutive(TACSMaterialProperties*,
