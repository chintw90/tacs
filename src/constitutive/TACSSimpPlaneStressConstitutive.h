...
#ifndef TACS_SIMP_PLANE_STRESS_CONSTITUTIVE_H
#define TACS_SIMP_PLANE_STRESS_CONSTITUTIVE_H
...
*/
class TACSSimpPlaneStressConstitutive : public TACSPlaneStressConstitutive {
 public:
  TACSSimpPlaneStressConstitutive( TACSMaterialProperties *properties,
				   TacsScalar _t=1.0, int _tNum=-1,
				   TacsScalar _q = 3.0,
				   TacsScalar _tlb=1e-3, TacsScalar _tub=1.0 );
  ~TACSSimpPlaneStressConstitutive();
